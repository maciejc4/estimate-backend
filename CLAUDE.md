...
- Always run the app locally and check for errors before commiting
- Always fix detected errors before commiting
- Always review code changes before commiting
- During implementation - always follow DDD principles
- Always commit your changes to Git repository
- Always push your changes to remote repository
- Always follow small commits practicies
